...
ml = ml.pls
MSE = list.append(MSE, sapply(1:G, function(g) mean((predict.wrapper(ml, X.test.list[[g]], r.list[[g]])- Y.test.list[[g]])^2)))
...
ml = ml.pls.list
MSE = list.append(MSE, sapply(1:G, function(g) mean((predict.wrapper(ml[[g]], X.test.list[[g]], r.list[[g]])- Y.test.list[[g]])^2)))
