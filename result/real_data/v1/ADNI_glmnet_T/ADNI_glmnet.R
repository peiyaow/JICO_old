...
# global ridge
ml.ridge.global = cv.glmnet(x=X.train, y= Y.train, alpha = 0, standardize = standardize)
...
# global EN
ml.EN.global = cv.glmnet(x=X.train, y= Y.train, alpha = 0.5, standardize = standardize)
...
# global lasso
ml.lasso.global = cv.glmnet(x=X.train, y= Y.train, alpha = 1, standardize = standardize)
...
# class ridge
ml.ridge.X.class = lapply(1:n_label, function(ix) cv.glmnet(x=X.train.list[[ix]], y=Y.train.list[[ix]], alpha = 0, standardize = standardize))
...
# class EN
ml.EN.X.class = lapply(1:n_label, function(ix) cv.glmnet(x=X.train.list[[ix]], y=Y.train.list[[ix]], alpha = 0.5, standardize = standardize))
...
# class lasso
ml.lasso.X.class = lapply(1:n_label, function(ix) cv.glmnet(x=X.train.list[[ix]], y=Y.train.list[[ix]], alpha = 1, standardize = standardize))
