...
ridge.OLS.U = cv.glmnet(x = U.train, y = HY.train, alpha = 0, standardize = standardize)
EN.OLS.U = cv.glmnet(x = U.train, y = HY.train, alpha = 0.5, standardize = standardize)
lasso.OLS.U = cv.glmnet(x = U.train, y = HY.train, alpha = 1, standardize = standardize)
