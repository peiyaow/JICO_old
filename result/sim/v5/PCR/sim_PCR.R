...
ml = ml.pls
MSE = list.append(MSE, sapply(1:G, function(g) mean((predict(ml, newdata = X.test.list[[g]], ncomp = r+r.list[[g]])[,,1] - Y.test.list[[g]])^2)))
...
# row.names(MSE) = c("iter.OLS", "iter.PLS", "iter.PCR", 
#                    "global.ridge", "global.PLS", "global.PCR", 
#                    "group.ridge", "group.PLS", "group.PCR")
